<?php
//si usu_tipo no es 1, redirigir a denegado.html
session_start();
...
<head>
    ...
    <title>Story Bridger (admin)</title>
...
<body>
    ...
    <header>
        ...
        <div class="header-right">
            <div class="user">
                <a href="mantenedor.php">Mantenedor</a> |<a href="user.html">Mi Perfil </a> | <a href="logout.php">Cerrar Sesión</a>
            </div>
